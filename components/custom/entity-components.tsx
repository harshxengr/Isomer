import { PlusIcon, SearchIcon, TriangleAlertIcon, Loader2Icon, MoreVerticalIcon, TrashIcon } from "lucide-react";
...
const handleRemove = async (e: React.MouseEvent<HTMLDivElement>) => {
    e.preventDefault();
    e.stopPropagation();
